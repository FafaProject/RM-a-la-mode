...
<head>
    ...
    <link rel="stylesheet" href="css/stFiltros.css">
</head>
<body>
    <?php
   ...
   <section class="catalogoGeneral">
    <?php
        ...
        if (isset($_GET['filter']) && $_GET['filter'] == '1') {
            ...
            $sql = "SELECT nombre, precio, imagen, detalles, id_prenda, stock FROM prendas WHERE tipo >= '0' AND nombre = '$filtroBUSQ'";
        } else {
            if ($_GET['catalogo'] == '1'){
                if($filtroBusqueda != ''){
            ...
            if ($_GET['catalogo'] == '3'){
                ...
                if($filtroBusqueda != ''){
                    $sql = "SELECT nombre, precio, imagen, id_prenda, stock FROM prendas WHERE nombre = '$filtroBusqueda'";
                }
                else{
                    $sql = "SELECT nombre, precio, imagen, id_prenda, stock FROM prendas";
                }
